...
response.write "    <td height='30'><a href=""yjhzj.asp"">月计划管理首页</a>&nbsp;|&nbsp;<a href=""yjh_view.asp?action=addyjh"">添加月计划计划</a>&nbsp;|&nbsp;<a href=""yzj_view.asp?action=addyzj"">添加月计划总结</a></td>"& vbCrLf
response.write "  </tr>"& vbCrLf
...
dim rscj,sqlcj,rsbz,sqlbz,sql,rs
   response.write"<form method='post' action='yjh_view.asp' name='form1'>"
...
sub edit()
   ...
   response.write"<form method='post' action='yjh_view.asp' name='form1' onsubmit='javascript:return checkadd();'>"
   response.write"<table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border' >"
   response.write"<tr class='title'><td height='22' colspan='2'>"

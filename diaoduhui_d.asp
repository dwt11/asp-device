...
<DIV class="box960">
  <div class="boxl">
    <div class="t1">
      <div class="dq">当前位置：<a href="/">首页</a> > 工作落实&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
	 <%  
...
response.write "      <td style=""border-bottom-style: solid;border-width:1px"" width=""80px""><div align=""center""><strong>来源</strong></div></td>"
response.write "      <td style=""border-bottom-style: solid;border-width:1px"" width=""150""><div align=""center""><strong>任务内容</strong></div></td>"
...
response.write "    </tr>"
	...
	if wangong=0 then sqlpxst="SELECT * from huiyiluoshi ORDER BY id DESC"
	if wangong=1 then sqlpxst="SELECT * from huiyiluoshi where isno=true ORDER BY id DESC"
	if wangong=2 then sqlpxst="SELECT * from huiyiluoshi where isno=false ORDER BY id DESC"
...
response.write "<p align='center'>未添加</p>" 
           ...
           do while not rspxst.eof and rowcount>0
                 ...
                 response.write "     <td  style=""border-bottom-style: solid;border-width:1px"" ><div align=""center"">"&rspxst("ly")&"</div></td>"
				 if rspxst("isno")=false then 
                 response.write "<td style=""border-bottom-style: solid;border-width:1px""  ><a href=diaoduhui_view.asp?id="&rspxst("id")&" target=_blank style=color:#FF0000>"&rspxst("pxst_title")&"</a></td>"
				 else
                 response.write "<td style=""border-bottom-style: solid;border-width:1px"" ><a href=diaoduhui_view.asp?id="&rspxst("id")&" target=_blank>"&rspxst("pxst_title")&"</a></td>"

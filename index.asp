...
Dwt.out "            <tr>"& vbCrLf
Dwt.out "                <td height='25' align='right'>用户名：</td><td height='25'><input name='UserName' type='text' id='UserName' size='10' maxlength='20' value='admin'></td>"& vbCrLf
Dwt.out "</tr>"& vbCrLf
Dwt.out "                <tr>"& vbCrLf
Dwt.out "                <td height='25' align='right'>密&nbsp;&nbsp;码：</td><td height='25'><input name='password' type='password' id='Password' size='10' maxlength='20' value='123456'></td>"& vbCrLf
Dwt.out "                </tr>"& vbCrLf
...
%>
      ...
      <td vAlign=top>
           ...
           <table cellSpacing=0 cellPadding=0 width="100%" border=0>
                <tr>
                  <td class=main_title_1i>安全短板公示</td>
                  <td class=main_title_1i width="20%"><a href=anquangs_d.asp?wangong=2><SPAN>更多...</SPAN></td>
                </tr>
                <tr>
                  <td height=136 colspan="2" vAlign=top class=main_tdbg_282i>
            <marquee  scrollamount=1 height=200 onmouseover=stop()  onmouseout=start() direction='up'><table width='98%' border='1'>
            
            
      <tr>
    <td align="center">短板内容</td>
    <td align="center">责任单位及责任人</td>
    <td align="center">状态</td>
		...
		<%	
i =0
sqlqxtb="SELECT  * from anquangs where isno=false ORDER BY id DESC"
'sqlqxtb="SELECT top 7 * from anquangs where pxst_class=1 and isno=false ORDER BY id DESC"
set rsqxtb=server.createobject("adodb.recordset")
rsqxtb.open sqlqxtb,connaq,1,1
if rsqxtb.eof and rsqxtb.bof then 
Dwt.out "<p align='center'>未添加内容</p>" 
else
do while not rsqxtb.eof
  ...
  <tr>
    <td>&nbsp;<a href="anquangs_view.asp?ID=<%=rsqxtb("id")%>" title="<%=rsqxtb("pxst_title")%>" target="_blank" style="color:#FF0000"><%=title%></a></td>
    <td>&nbsp;<%=rsqxtb("zr_danwei")%>&nbsp;&nbsp;<%=rsqxtb("zr_ren")%></td>
    <td nowrap style="white-space:nowrap;word-break:nowrap">未完成</td>
  </tr>
...
%>
              ...
              <table cellSpacing=0 cellPadding=0 width="100%" border=0>
                <tr>
                  <td class=main_title_1i>工作落实</td>
                  <td class=main_title_1i width="20%"><a href=diaoduhui_d.asp?wangong=2><SPAN>更多...</SPAN></td>
                </tr>
                <tr>
                  <td height=136 colspan="2" vAlign=top class=main_tdbg_282i>
            <marquee  scrollamount=2 height=200 onmouseover=stop()  onmouseout=start() direction='up'><table width='98%' border='1'>
...
do while not rsqxtb.eof
  ...
  <tr>
    <td>&nbsp;<a href="diaoduhui_view.asp?ID=<%=rsqxtb("id")%>" title="<%=rsqxtb("pxst_title")%>" target="_blank" style="color:#FF0000"><%=title%></a></td>
    <td>&nbsp;<%=rsqxtb("zr_danwei")%>&nbsp;&nbsp;<%=rsqxtb("zr_ren")%></td>
    <td nowrap style="white-space:nowrap;word-break:nowrap">未完成</td>
  </tr>

...
sqlpxst="select * from pxst where id="&request("id")
...
<head>
<title><%=rspxst("pxst_title")%>-试题</title>
    ...
    <tr>
      ...
      <!--本站最新文章代码开始-->
        <table cellSpacing=0 cellPadding=0 width="100%" border=0>
          <tr>
            <td class=main_title_1i>当前位置：<a href="/" class=class>信息管理系统首页</a> &gt;&gt;&gt; 试题 &gt;&gt;&gt; <%=rspxst("pxst_title")%></td>
          </tr>
          <tr>
            <td  vAlign=top class=main_tdbg_575><br><div align="center"><font color="#05006c" size=larger><%=rspxst("pxst_title")%></font> <br>
              <br><hr width="80%" size="1">
              </div>
              <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">发布时间：<font color="#990000"><%=rspxst("pxst_date")%></font>　 试题发布：<font color="#990000"><%=rspxst("pxst_zz")%> </font></td>
                </tr>
                <tr>
                  <td><br>
                      <%=imgCode(rspxst("pxst_body"))%> </td>
                </tr>
                <tr>

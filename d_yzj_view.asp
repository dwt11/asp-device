...
response.write "<title>信息管理系统月总结内容显示</title>"& vbCrLf
...
response.write "   <td height='22' colspan='2' align='center'><strong>党支部月总结</strong></td>"& vbCrLf
response.write "  </tr>  "& vbCrLf
response.write "<tr class='tdbg'>"& vbCrLf
response.write "    <td width='70' height='30'><strong>管理导航：</strong></td>"& vbCrLf
response.write "    <td height='30'><a href=""d_yjhzj.asp"">月计划总结管理首页</a>&nbsp;|&nbsp;<a href=""d_yjh_view.asp?action=addyjh"">添加月计划</a>&nbsp;|&nbsp;<a href=""d_yzj_view.asp?action=addyzj"">添加月总结</a></td>"& vbCrLf
response.write "  </tr>"& vbCrLf
...
dim rscj,sqlcj,rsbz,sqlbz,sql,rs
  ...
  'if session("level")=0 then 
    ...
    response.write"<option >请选择所属支部</option>"
		response.write"<option  value=1>维修一党支部</option>"
		response.write"<option  value=2>维修二党支部</option>"
		response.write"<option  value=3>机关党支部</option>"
...
sub saveaddyzj()    
	  ...
	  if yzj_body="" then   yzj_body="未添加内容"
	  rsadd("body")=yzj_body
...
sub edit()
   ...
   response.write"<div align='center'><strong>编辑月总结</strong></div></td>    </tr>"
     ...
     response.write"<tr class='tdbg'><td width='12%' align='right' class='tdbg'><strong>所属支部： </strong></td>"   & vbCrLf   
	  		...
	  		dim sszb
		if rsedit("sscj")=1 then sszb="维修一党支部"
		if rsedit("sscj")=2 then sszb="维修二党支部"
		if rsedit("sscj")=3 then sszb="机关党支部"
...
sub yzj()
   ...
   '显示车间级的月总结总结
      ...
      rsyzj.open sqlyzj,conna,1,1
    	  		dim sszb
		if request("sscj")=1 then sszb="维修一党支部"
		if request("sscj")=2 then sszb="维修二党支部"
		if request("sscj")=3 then sszb="机关党支部"
		...
		if request("sscj")=5 then sszb="维修四党支部"
		 ...
		 response.write "<br><table width=""90%""  border=""0"" align=""center"" cellpadding=""0"" cellspacing=""1"">"
             ...
             response.write " <tr class=""title""><td height=40><div align=center><strong>"&sszb&request("year")&"年"&request("month")&"月份工作总结</strong></div>"
             response.write "</td></tr>"

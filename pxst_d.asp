...
response.write "    </tr>"
sqlpxst="SELECT * from pxst ORDER BY id DESC"
...
response.write "<p align='center'>未添加新闻</p>" 
           ...
           do while not rspxst.eof and rowcount>0
                 ...
                 response.write "     <td  style=""border-bottom-style: solid;border-width:1px"" width=""5%""><div align=""center"">"&rspxst("id")&"</div></td>"
                 response.write "      <td style=""border-bottom-style: solid;border-width:1px"" width=""40%""><a href=pxst_view.asp?id="&rspxst("id")&" target=_blank>"&rspxst("pxst_title")&"</a></td>"
                 response.write "      <td width=""10%"" style=""border-bottom-style: solid;border-width:1px""><div align=""center"">"&rspxst("pxst_zz")&"&nbsp;</div></td>"
                 response.write "      <td width=""10%"" style=""border-bottom-style: solid;border-width:1px""><div align=""center"">"&rspxst("pxst_date")&"</div></td>"
                 response.write "    </tr>"
                 RowCount=RowCount-1
          rspxst.movenext
          loop

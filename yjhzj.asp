...
dwt.out  "   <td height='22' colspan='2' align='center'><strong>月计划总结页</strong></td>"& vbCrLf
dwt.out  "  </tr>  "& vbCrLf
dwt.out  "<tr class='tdbg'>"& vbCrLf
dwt.out  "    <td width='70' height='30'><strong>管理导航：</strong></td>"& vbCrLf
dwt.out  "    <td height='30'><a href=""yjhzj.asp"">月计划总结首页</a>&nbsp;|&nbsp;<a href=""yjh_view.asp?action=addyjh"">添加月计划</a>&nbsp;|&nbsp;<a href=""yzj_view.asp?action=addyzj"">添加月总结</a></td>"& vbCrLf
dwt.out  "  </tr>"& vbCrLf
...
sub main()
  dim i,ii
  dim sql,rs,years(500),months(500)
  ii=1
   ...
   for i=i to 1 step -1
	 ...
	 dwt.out  "&nbsp;&nbsp;&nbsp;&nbsp;<a href=yjhzj.asp?action=yjh_bz&year="&years(i)&"&month="&months(i)&">"&years(i)&"年"&months(i)&"月</a>&nbsp;&nbsp;&nbsp;"
   next
   dwt.out "</tr></td></table>"
   ...
   for i=i to 1 step -1
	 ...
	 ii=ii+1
	 if len(months(i))<>2 then months(i)="0"&months(i)  
	 dwt.out  "&nbsp;&nbsp;&nbsp;&nbsp;<a href=yjhzj.asp?action=yzj_bz&year="&years(i)&"&month="&months(i)&">"&years(i)&"年"&months(i)&"月</a>&nbsp;&nbsp;&nbsp;"
   next
   dwt.out "</tr></td></table>"
   ...
   if rsyjh.eof and rsyjh.bof then 
      ...
      do while not rsyjh.eof
		xh=xh+1
				...
				dwt.out  "      <td style=""border-bottom-style: solid;border-width:1px"" width=""63%""><div align=""center""><a href=yjh_view.asp?action=yjh&month="&request("month")&"&sscj="&rsyjh("sscj")&"&year="&request("year")&">"&sscjh(rsyjh("sscj"))&"</a></div></td>"
				...
				call editdel(rsyjh("id"),rsyjh("sscj"),"yjh_view.asp?action=edit&id=","yjh_view.asp?action=del&id=")
                dwt.out  "</div></td></tr>"
          rsyjh.movenext
     loop
     dwt.out  "</table>"
   ...
   if rsyzj.eof and rsyzj.bof then 
      ...
      do while not rsyzj.eof
		xh=xh+1
                dwt.out  "<tr class=""tdbg"" onmouseout=""this.style.backgroundColor=''"" onmouseover=""this.style.backgroundColor='#BFDFFF'"">"
                dwt.out  "     <td  style=""border-bottom-style: solid;border-width:1px"" width=""5%""><div align=""center"">"&xh&"</div></td>"
				dwt.out  "      <td style=""border-bottom-style: solid;border-width:1px"" width=""63%""><div align=""center""><a href=yzj_view.asp?action=yzj&month="&request("month")&"&sscj="&rsyzj("sscj")&"&year="&request("year")&">"&sscjh(rsyzj("sscj"))&"</a></div></td>"
				dwt.out  "<td width=""20%"" style=""border-bottom-style: solid;border-width:1px""><div align=""center"">"
				'<a href=tocsv.asp?action=yzjmain&titlename=月总结&month="&request("month")&"&sscj="&rsyzj("sscj")&"&year="&request("year")&">导出到EXCEL文档</a>
                call editdel(rsyzj("id"),rsyzj("sscj"),"yzj_view.asp?action=edit&id=","yzj_view.asp?action=del&id=")
				dwt.out  "</div></td></tr>"
          rsyzj.movenext
     loop
     dwt.out  "</table>"

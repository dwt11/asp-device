...
dim rscj,sqlcj
	...
	dwt.out"		<H3 style='MARGIN-BOTTOM: 5px'>添加缺陷记录</H3>"& vbCrLf
	...
	dwt.out"				<LABEL style='WIDTH: 75px' >检查单位:</LABEL>"& vbCrLf
	...
	if session("level")=0 then 
		...
		dwt.out"<option  selected>选择车间</option>"& vbCrLf
...
dwt.out"			<DIV class='x-form-ct'>"& vbCrLf
	...
	dwt.out"			  <DIV class='x-form-item'>"& vbCrLf
	dwt.out"				<LABEL style='WIDTH: 75px' >所属车间:</LABEL>"& vbCrLf
	dwt.out"				<DIV class=x-form-element style='PADDING-LEFT: 80px'>"& vbCrLf
		dwt.out"<select name='qxdj_sscj' style='WIDTH: 175px' size='1'>"& vbCrLf
		dwt.out"<option  selected>缺陷所属车间</option>"& vbCrLf
		sqlcj="SELECT * from levelname where levelclass=1"& vbCrLf
		set rscj=server.createobject("adodb.recordset")
		rscj.open sqlcj,conn,1,1
		do while not rscj.eof
...
dwt.out"				</DIV>"& vbCrLf
	...
	dwt.out"			  <DIV class=x-form-clear-left></DIV>"& vbCrLf
        ...
        dwt.out"			  <DIV class='x-form-item'>"& vbCrLf
	dwt.out"				<LABEL style='WIDTH: 75px' >缺陷来源:</LABEL>"& vbCrLf
	dwt.out"				<DIV class='x-form-element' style='PADDING-LEFT: 80px'>"& vbCrLf
              dwt.out outdatadict ("source","缺陷来源",onnumb)
	dwt.out"				</DIV>"& vbCrLf
	dwt.out"			  </DIV>"& vbCrLf
	dwt.out"			  <DIV class=x-form-clear-left></DIV>"& vbCrLf
...
sub edit()
	...
	dwt.out"	<DIV class=x-box-mr>"& vbCrLf
	dwt.out"	  <DIV class=x-box-mc>"& vbCrLf
	dwt.out"		<H3 style='MARGIN-BOTTOM: 5px'>编辑缺陷记录</H3>"& vbCrLf
	dwt.out"		<DIV id=form-ct>"& vbCrLf
...
dwt.out"				<LABEL style='WIDTH: 75px' >所属车间:</LABEL>"& vbCrLf
	...
	dwt.out"				<LABEL style='WIDTH: 75px' >缺陷来源:</LABEL>"& vbCrLf
	dwt.out"				<DIV class='x-form-element' style='PADDING-LEFT: 80px'>"& vbCrLf
	dwt.out outdatadict2 ("source","缺陷来源",onnumb,rsedit("source"))& vbCrLf
	dwt.out"				</DIV>"& vbCrLf
	dwt.out"			  </DIV>"& vbCrLf
...
sub main()
	...
	dwt.out "        <SPAN class='x-layout-panel-hd-text' style:'top:0px;'>缺陷记录"&title&"</span>"& vbCrLf
	dwt.out "     </div>"& vbCrLf
	...
	if rsqxdj.eof and rsqxdj.bof then 
	   message "未找到相关内容"
		...
		dwt.out "      <td class='x-td'><DIV class='x-grid-hd-text'>检查</div></td>"
dwt.out "      <td class='x-td'><DIV class='x-grid-hd-text'>所属车间</div></td>"
		dwt.out "      <td class='x-td'><DIV class='x-grid-hd-text'>位号</div></td>"
                dwt.out "      <td class='x-td'><DIV class='x-grid-hd-text'>缺陷来源</div></td>"
...
dwt.out "      <td style=""cloudchen:expression(noWrap=true);border-bottom-style: solid;border-width:1px""><div align=""center"">"
			...
			if rsqxdj("zgjg") then 
			   ...
			   dwt.out "&nbsp;</td>"
                        ...
                        dwt.out "      <td style=""border-bottom-style: solid;border-width:1px"">"
			dwt.out dispalydatadict("缺陷来源",rsqxdj("source"))
	                dwt.out "&nbsp;</td>"   
			...
			if session("levelclass")=7 and rsqxdj("isck")=false then dwt.out "<a href='qxdjzgc.asp?id="&rsqxdj("id")&"&action=isck' onClick=""return confirm('确定设置为厂控缺陷吗？');"">厂控缺陷</a> "
...
sub search()
	...
	if displaypagelevelh(session("groupid"),1,session("pagelevelid")) then dwt.out "  <a href=""qxdjzgc.asp?action=add"">添加记录</a>&nbsp;&nbsp;"
	...
	if cint(request("sscj"))=rscj("levelid") then dwt.out" selected"
		...
		rscj.close
		set rscj=nothing
		dwt.out "<option value='qxdjzgc.asp?sscj=1000'>厂控</option>"
		dwt.out "     </select>	" & vbCrLf
	dwt.out "<a href=qxdjzgc.asp?allchange=1>已整改记录</a> <a href=qxdjzgc.asp>未整改记录</a>"

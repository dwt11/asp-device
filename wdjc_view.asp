...
<head>
<title><%=request("wz")%>-<%=request("name")%>-温度巡检记录</title>
    ...
    <tr>
      ...
      <!--本站最新文章代码开始-->
        <table cellSpacing=0 cellPadding=0 width="100%" border=0>
          <tr>
            <td class=main_title_1i>当前位置：<a href="/" class=class>信息管理系统首页</a> &gt;&gt;&gt; <%=request("wz")%>-<%=request("name")%>-温度巡检记录</td>
          </tr>
        ...
        response.Write "<br><table  border='1'  cellpadding='1' cellspacing='1' align=center>"
			  response.Write "		  <tr>"
			  response.Write "		    <td align=center>日期</td>"
			  response.Write "		    <td align=center>位置</td>"
			  response.Write "		    <td align=center>名称</td>"
			  response.Write "		    <td align=center>温度</td>"
			  response.Write "	      </tr>"
		  ...
		  response.Write "		  <tr>"
		  response.Write "		    <td colspan='5' align=center>未添加记录</td>"
		  response.Write "	      </tr>"
		  else

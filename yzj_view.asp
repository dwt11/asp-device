...
response.write "   <td height='22' colspan='2' align='center'><strong>月总结总结</strong></td>"& vbCrLf
response.write "  </tr>  "& vbCrLf
response.write "<tr class='tdbg'>"& vbCrLf
response.write "    <td width='70' height='30'><strong>管理导航：</strong></td>"& vbCrLf
response.write "    <td height='30'><a href=""yjhzj.asp"">月计划总结管理首页</a>&nbsp;|&nbsp;<a href=""yjh_view.asp?action=addyjh"">添加月计划</a>&nbsp;|&nbsp;<a href=""yzj_view.asp?action=addyzj"">添加月总结</a></td>"& vbCrLf
response.write "  </tr>"& vbCrLf
...
dim rscj,sqlcj,rsbz,sqlbz,sql,rs
   response.write"<form method='post' action='yzj_view.asp' name='formyzj'>"
...
sub saveaddyzj()    
      ...
      rsadd.close
      set rsadd=nothing
	  response.write"<Script Language=Javascript>location.href='yjhzj.asp';</Script>"
end sub
...
sub edit()
   ...
   response.write"<form method='post' action='yzj_view.asp' name='form1' onsubmit='javascript:return checkadd();'>"
   response.write"<table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border' >"
   response.write"<tr class='title'><td height='22' colspan='2'>"

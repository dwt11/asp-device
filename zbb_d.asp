...
response.write "      <td width=""10%"" style=""border-bottom-style: solid;border-width:1px""><div align=""center""><strong>时间</strong></div></td>"
response.write "    </tr>"
...
response.write "<p align='center'>未添加新闻</p>" 
           ...
           do while not rszbb.eof and rowcount>0
                 ...
                 response.write "      <td style=""border-bottom-style: solid;border-width:1px"" width=""40%""><a href=zbb_view.asp?id="&rszbb("id")&" target=_blank>"&rszbb("title")&"</a></td>"
                 response.write "      <td width=""10%"" style=""border-bottom-style: solid;border-width:1px""><div align=""center"">"&rszbb("date")&"</div></td>"
                 response.write "    </tr>"
                 RowCount=RowCount-1
          rszbb.movenext
          loop

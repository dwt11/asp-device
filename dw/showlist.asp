...
<DIV class="box960">
  <div class="boxl">
    <div class="t1">
      <div class="dq">当前位置：<a href="/">首页</a> > <a href="/dw">党建</a> <%=gettclassname(classid)%> > <%=classname%> </div>
    </div>
    <p class="br"> </p>
    <div class="boxlc boxlt">
      <%			
				sqltree3="SELECT * from dgtzl_body where index="&classid&" and news_class=1 order by id desc"& vbCrLf

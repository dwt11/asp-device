...
dwt.out "<html>"& vbCrLf
dwt.out "<head>" & vbCrLf
dwt.out "<title>更换记录汇总</title>"& vbCrLf
...
dwt.out"<body leftmargin='2' topmargin='0' marginwidth='0' marginheight='0'>"& vbCrLf
	...
	dwt.out "        <SPAN class='x-layout-panel-hd-text' style:'top:0px;'>更换记录汇总</span>"& vbCrLf
	dwt.out "     </div>"& vbCrLf
...
sub main()
  ...
  if keys<>"" then sqljxwhere2=" or  gh_ren like '%" &keys& "%'  ) "   '此段是用来兼容  更换的旧数据
...
sub search()
	...
	dwt.out "<a href=sb_ghjl_left.asp?action=ghcount>按更换次数排列</a>  <a href=?action=dcs>只显示DCS相关</a>"

...
sqlzbb="select * from jlclgl where id="&request("id")
    ...
    <tr>
      ...
      <!--本站最新文章代码开始-->
        <table cellSpacing=0 cellPadding=0 width="100%" border=0>
          <tr>
            <td class=main_title_1i>当前位置：<a href="/" class=class>信息管理系统首页</a> &gt;&gt;&gt; 车辆信息表 &gt;&gt;&gt; <%=rszbb("title")%></td>
          </tr>
          <tr>

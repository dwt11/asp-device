...
sub add()
   dwt.out"<br><br><br><form method='post' action='huiyiluoshi_fk.asp' name='form1' onsubmit='javascript:return CheckAdd();'>"
   ...
   dwt.out"<IMG src='/images2006/calendar/date_selector.gif' border='0' align='absMiddle'></a></td></tr>"& vbCrLf
	...
	dwt.out"<input name='action' type='hidden' id='action' value='saveadd'> <input name='huiyiluoshi_id' type='hidden' id='huiyiluoshi_id' value='"&request("huiyiluoshi_id")&"'>   <input  type='submit' name='Submit' value=' 添 加 ' style='cursor:hand;'>&nbsp;<input name='Cancel' type='button' id='Cancel' value=' 取 消 ' onClick=""window.location.href='qxtb.asp';"" style='cursor:hand;'></td>  </tr>"
	dwt.out"</table></form>"
end sub	

sub saveadd()    
      set rsadd=server.createobject("adodb.recordset")
      sqladd="select * from huiyiluoshi_fk" 
...
sub edit()
   ...
   sqledit="select * from huiyiluoshi_fk where huiyiluoshi_id="&huiyiluoshi_id&" and huiyiluoshi_fk_sscj="&session("levelclass")
   rsedit.open sqledit,conne,1,1

   dwt.out"<form method='post' action='huiyiluoshi_fk.asp' name='form1' onsubmit='javascript:return CheckAdd();'>"
   ...
   dwt.out"<IMG src='/images2006/calendar/date_selector.gif' border='0' align='absMiddle'></a></td></tr>"& vbCrLf
    ...
    dwt.out"<tr> <td height='40' colspan='2' align='center' class='tdbg'>"
	dwt.out"<input name='action' type='hidden' id='action' value='saveedit'>	<input name='huiyiluoshi_id' type='hidden' id='huiyiluoshi_id' value='"&request("huiyiluoshi_id")&"'>   <input  type='submit' name='Submit' value=' 保 存 ' style='cursor:hand;'>&nbsp;<input name='Cancel' type='button' id='Cancel' value=' 取 消 ' onClick=""window.location.href='qxtb.asp';"" style='cursor:hand;'></td>  </tr>"
	dwt.out"</table></form>"
...
'编辑保存
set rsedit=server.createobject("adodb.recordset")
sqledit="select * from huiyiluoshi_fk where huiyiluoshi_id="&ReplaceBadChar(Trim(request("huiyiluoshi_id")))&" and huiyiluoshi_fk_sscj="&session("levelclass")
...
sqldel="delete * from huiyiluoshi_fk where huiyiluoshi_id="&huiyiluoshi_id&" and huiyiluoshi_fk_sscj="&session("level")
